...
| **`/soundtrack`** | Search for movie and TV show soundtracks with iTunes and Spotify integration | Movies, TV Shows |
...
- **`/bracket`** - Host comprehensive movie/TV tournaments with flexible group stage voting (4-12 groups, each with 4 movies). Dynamic wildcard system and single-elimination knockout brackets adapt to tournament size (8-48 participants). Perfect for community competitions!
