...
- Check `/eggshen-config-watch-party rate-limit view` to see current settings
- Use `/eggshen-config-watch-party rate-limit clear user:@someone` for emergency overrides
